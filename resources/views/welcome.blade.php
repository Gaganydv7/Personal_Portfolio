                ...
                <div class="col-lg-6">
                    ...
                    <div class="resume-item">
                        ...
                        <ul>
                            ...
                            <li>Lead design and development of enterprise application using PHP, JavaScript, JQuery, CSS, HTML, Laravel Framework and SQl.</li>
                        </ul>
                        </p>
                    </div>
                    <div class="resume-item">
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        ...
                        <li data-filter=".filter-card">Educational certificates</li>
            ...
            <div class="row portfolio-container">
                ...
                $i=11;
                @endphp
                @for($i;$i<16;$i++) <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="{{asset('assets/img/portfolio/'.$images[$i]->image)}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>{{$images[$i]->img_heading}}</h4>
                            <p> {{$images[$i]->img_year}}</p>
                            <div class="portfolio-links">
                                <a href="{{asset('assets/img/portfolio/'.$images[$i]->image)}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$images[$i]->title}}"><i class="bx bx-plus"></i></a>
                                <a href="/pd/{{ $images[$i]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                            </div>
                        </div>
                    </div>
            </div>
            ...
            <!-- Iet 5th semester -->
            <!-- EDUCATIONAL CERTIFICATES START-->
            @php
            $i=0;
            @endphp
            @for($i;$i<11;$i++) <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                <div class="portfolio-wrap">
                    <img style="filter: invert(100%);" src="{{asset('assets/img/portfolio/'.$images[$i]->image)}}" class="img-fluid" alt="">
                    <div class="portfolio-info">

                        <!-- <img src="{{asset('assets/img/'.$images[0]->image)}}" class="img-fluid" alt="image not showing"> -->
                        <h4>{{$images[$i]->img_heading}}</h4>
                        <p> {{$images[$i]->img_year}}</p>
                        <div class="portfolio-links">
                            <a href="{{asset('assets/img/portfolio/'.$images[$i]->image)}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$images[$i]->title}}"><i class="bx bx-plus"></i></a>
        ...
        {{-- <!-- Iet 2nd year -->
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        <img style="filter: invert(100%);" src="assets/img/portfolio/iet2.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                        <h4>MCA 2nd Year</h4>
                            <p> 2019-2020</p>
                            <div class="portfolio-links">
                                <a href="assets/img/portfolio/iet2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of MCA 3rd & 4th Semester 2019-2020 from Institute of Engineering and Technology (IET)"><i class="bx bx-plus"></i></a>
                                <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/iet1.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>MCA 1st Year</h4>
                    <p> 2018-2019</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/iet1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of MCA 1st & 2nd Semester 2018-2019 from Institute of Engineering and Technology (IET)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca6.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 6th Semester</h4>
                    <p> 2017-2018</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca6.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 6th Semester 2017-2018 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca5.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 5th Semester</h4>
                    <p> 2017-2018</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca5.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 5th Semester 2017-2018 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca4.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 4th Semester</h4>
                    <p> 2016-2017</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca4.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 4th Semester 2016-2017 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca3.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 3rd Semester</h4>
                    <p> 2016-2017</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 3rd Semester 2016-2017 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca2.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 2nd Semester</h4>
                    <p> 2015-2016</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 2nd Semester 2015-2016 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/bca1.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>BCA 1st Semester</h4>
                    <p> 2015-2016</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/bca1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of BCA 1st Semester 2015-2016 from Dr Virendra Swarup Institute of Computer Studies (VSICS)"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/12.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>Intermediate</h4>
                    <p>2014-2015</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/12.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of Intermediate 2014-2015 from Hal Vidyalaya"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
                <img style="filter: invert(100%);" src="assets/img/portfolio/10.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                    <h4>High School</h4>
                    <p>2012-2013</p>
                    <div class="portfolio-links">
                        <a href="assets/img/portfolio/10.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Scorecard of High School 2012-2013 from Hal Vidyalaya"><i class="bx bx-plus"></i></a>
                        <a href="/pd/{{ $images[0]->id }}" data-gallery="portfolioDetailsGallery" data-glightbox="type: external" class="portfolio-details-lightbox" title="Portfolio Details"><i class="bx bx-link"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section id="contact" class="contact">
        <div class="container">
            ...
            <form action="{{route('contact')}}" id="addform" method="post" role="form" class="php-email-form mt-4">
                ...
                <br>
                <div class="text-center"><button class="btn btn-success" type="submit">Send Message
                    </button></div>
            </form>
